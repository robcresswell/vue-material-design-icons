<template>
  <div class="material-design-icon" id="screen-rotation-lock-icon" role="img" aria-labelledby="screen-rotation-lock-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="screen-rotation-lock-title">Screen rotation lock icon</title>
