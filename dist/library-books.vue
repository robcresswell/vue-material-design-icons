<template>
  <div class="material-design-icon" id="library-books-icon" role="img" aria-labelledby="library-books-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="library-books-title">Library books icon</title>
