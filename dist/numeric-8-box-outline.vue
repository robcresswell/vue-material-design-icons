<template>
  <div class="material-design-icon" id="numeric-8-box-outline-icon" role="img" aria-labelledby="numeric-8-box-outline-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="numeric-8-box-outline-title">Numeric 8 box outline icon</title>
