<template>
  <div class="material-design-icon" id="alarm-multiple-icon" role="img" aria-labelledby="alarm-multiple-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="alarm-multiple-title">Alarm multiple icon</title>
