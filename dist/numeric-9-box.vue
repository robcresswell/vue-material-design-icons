<template>
  <div class="material-design-icon" id="numeric-9-box-icon" role="img" aria-labelledby="numeric-9-box-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="numeric-9-box-title">Numeric 9 box icon</title>
