<template>
  <div class="material-design-icon" id="lightbulb-on-outline-icon" role="img" aria-labelledby="lightbulb-on-outline-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="lightbulb-on-outline-title">Lightbulb on outline icon</title>
