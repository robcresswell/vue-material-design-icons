<template>
  <div class="material-design-icon" id="account-box-outline-icon" role="img" aria-labelledby="account-box-outline-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="account-box-outline-title">Account box outline icon</title>
