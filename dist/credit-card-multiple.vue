<template>
  <div class="material-design-icon" id="credit-card-multiple-icon" role="img" aria-labelledby="credit-card-multiple-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="credit-card-multiple-title">Credit card multiple icon</title>
