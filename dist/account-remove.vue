<template>
  <div class="material-design-icon" id="account-remove-icon" role="img" aria-labelledby="account-remove-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="account-remove-title">Account remove icon</title>
