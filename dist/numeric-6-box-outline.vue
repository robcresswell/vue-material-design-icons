<template>
  <div class="material-design-icon" id="numeric-6-box-outline-icon" role="img" aria-labelledby="numeric-6-box-outline-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="numeric-6-box-outline-title">Numeric 6 box outline icon</title>
