<template>
  <div class="material-design-icon" id="account-circle-icon" role="img" aria-labelledby="account-circle-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="account-circle-title">Account circle icon</title>
