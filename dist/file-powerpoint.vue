<template>
  <div class="material-design-icon" id="file-powerpoint-icon" role="img" aria-labelledby="file-powerpoint-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="file-powerpoint-title">File powerpoint icon</title>
