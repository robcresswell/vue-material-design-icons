<template>
  <div class="material-design-icon" id="file-image-box-icon" role="img" aria-labelledby="file-image-box-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="file-image-box-title">File image box icon</title>
