<template>
  <div class="material-design-icon" id="chevron-double-left-icon" role="img" aria-labelledby="chevron-double-left-title">
    <svg width="24" height="24" viewBox="0 0 24 24">
      <title id="chevron-double-left-title">Chevron double left icon</title>
